...
const en: TextKeys = {
    ...
    CHOOSE_ALL_IMAGES_AT_ONCE: "Choose all you want to upload. Max upload of 50 images or 30MB. You can add more later (Up to 200 images in a template).",
    ...
    TEMPLATE_IMAGES_TOO_LARGE: "The uploaded images are too large. Please upload images with a maximum size of 30MB.",
    NOT_ENOUGH_TEMPLATE_IMAGES: "You need at least 4 images in a template.",
    ...
    SUPPORT_MESSAGE: `
<span class="text-lg">If you need help or have any questions, please contact us at <a href="mailto:contact@tierlistmaker.org" class="text-primary">
contact@tierlistmaker.org
    ...
    CREATE_A_NEW_TEMPLATE_DESCRIPTION: "Enter a name for you Tierlist Template",
    TEMPLATE_DESCRIPTION_SUBTITLE: "Enter a description for your Tierlist Template",
    TEMPLATE_CATEGORY_SUBTITLE: "Select a category for your Tierlist Template",
    PUBLIC_OR_PRIVATE_SUBTITLE: "Is your Tierlist Template for public or private use?",
    ENTER_ROW_NAMES_SUBTITLE: "Enter the names of the rows for your Tierlist Template",
    PRIVATE: "Private",
    PUBLIC: "Public",
    SELECT_A_COVER_IMAGE_SUBTITLE: "Select a cover image for your Tierlist Template",
    SELECT_A_SET_OF_IMAGES_SUBTITLE: "Select a set of images for your Tierlist Template",
    SURE_TO_CREATE_TEMPLATE: "Are you sure you want to create this template?",
    EDIT_GENERAL_INFORMATION_SUBTITLE: "Edit the general information of your Tierlist Template",
    EDIT_TEMPLATE_IMAGES_SUBTITLE: "Edit the images of your Tierlist Template",
    EDIT_TEMPLATE_ROWS_SUBTITLE: "Edit the Tiers of your Tierlist Template",
    UPDATE_COVER_IMAGE: "Update Cover Image",
    COVER: "Cover",
    EDIT_TEMPLATE_COVER_SUBTITLE: "Edit the cover image of your Tierlist Template",
    ADD: "Add",
