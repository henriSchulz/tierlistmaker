...
export const IMAGE_HEIGHT = isXsWindow() ? 80 : 108
            ...
            <TooltipTrigger>
                <div className="flex flex-row relative">
                    ...
                    <motion.div transition={{duration: 0.2}}
                                ...
                                whileTap={{scale: 0.93}}
                                onDoubleClick={() => controller.moveToDefault(item.id)}
                                onDragStart={(e) => {
                    ...
                    >
                        <img
                            ...
                            alt={item.name}
                            src={imgSrc}
                            className={`aspect-square object-fill object-center selector d-i`}
...
export const DropIndicator = ({beforeId, rowId}: { beforeId: string | null, rowId: string }) => {
    return (
        <div
            ...
            data-column={rowId}
            className={`transition ease-in-out h-[${IMAGE_HEIGHT}px] bg-gray-100 opacity-0`}
        />
    );
};