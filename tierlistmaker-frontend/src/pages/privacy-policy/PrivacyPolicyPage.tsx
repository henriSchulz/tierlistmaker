...
export default function () {
    return <Card className="lg:mx-20 mx-5 mt-8 mb-8">
        ...
        <Helmet>
            <title>
                Privacy Policy - Tierlistmaker
            </title>
        </Helmet>

        <div className="p-8 ppc">
            ...
            <ul className="list-disc ml-8">
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                    Agreement) refers to Tierlistmaker.org.
                </li>
                ...
                <li><strong>Website</strong> refers to Tierlistmaker.org, accessible from https://tierlistmaker.org</li>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-2">Use of Your Personal Data</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-2">Retention of Your Personal Data</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-2">Transfer of Your Personal Data</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-2">Delete Your Personal Data</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-2">Disclosure of Your Personal Data</h2>

            <h3 className="text-xl font-bold mt-4 mb-2">Business Transactions</h3>
            ...
            <h3 className="text-xl font-bold mt-4 mb-2">Law enforcement</h3>
            ...
            <h3 className="text-xl font-bold mt-4 mb-2">Other legal requirements</h3>
            ...
            <ul className="list-disc ml-8">
                <li>By email: contact@tierlistmaker.org</li>
            </ul>
